...
#
# Created: Sat Oct 12 23:39:44 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("img/aphid.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("img/indent_remove.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_unindent.setIcon(icon2)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("img/save.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8("img/tri_right.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_run.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8("img/zen.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_zen.setIcon(icon7)
        self.b_zen.setObjectName(_fromUtf8("b_zen"))
        self.gridLayout_3.addWidget(self.b_zen, 0, 7, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.b_settings, 0, 4, 1, 1)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8("img/home.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_help.setIcon(icon9)
        self.b_help.setObjectName(_fromUtf8("b_help"))
        self.gridLayout_3.addWidget(self.b_help, 0, 5, 1, 1)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8("img/wordwrap.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_wordwrap.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8("img/comment.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_comment.setIcon(icon11)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8("img/workspace.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_workspace.setIcon(icon13)
