...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("img/wordwrap.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_wordwrap.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("img/indent.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_indent.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("img/indent_remove.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_unindent.setIcon(icon3)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8("img/search.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_find.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8("img/tri_right.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_run.setIcon(icon8)
        ...
        self.b_zen = QtGui.QToolButton(self.frame)
        self.b_zen.setMinimumSize(QtCore.QSize(26, 0))
        self.b_zen.setMaximumSize(QtCore.QSize(26, 24))
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8("img/zen.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_zen.setIcon(icon9)
        self.b_zen.setObjectName(_fromUtf8("b_zen"))
        self.gridLayout_3.addWidget(self.b_zen, 0, 8, 1, 1)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8("img/plugin.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_plugins.setIcon(icon11)
        ...
        self.gridLayout_2.addItem(spacerItem6, 0, 9, 1, 1)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8("img/workspace.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_workspace.setIcon(icon14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.b_indent.setText(_translate("MainWindow", "Save", None))
        self.b_unindent.setToolTip(_translate("MainWindow", "Unindent", None))
        self.b_unindent.setText(_translate("MainWindow", "Save", None))
        self.b_open.setToolTip(_translate("MainWindow", "Open", None))
        self.b_open.setText(_translate("MainWindow", "Save", None))
        ...
        self.b_help.setText(_translate("MainWindow", "Save", None))
        ...
        self.b_plugins.setText(_translate("MainWindow", "Save", None))
