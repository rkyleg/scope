...
#
# Created: Thu Aug  6 21:05:39 2015
...
" }"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("../../style/img/wrench.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_browse_2.setIcon(icon)
