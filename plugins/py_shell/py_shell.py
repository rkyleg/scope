# Code Modified From Hassan Syed (http://stackoverflow.com/questions/12431555/enabling-code-completion-in-an-embedded-python-interpreter)
...
##class PyInterp(Qsci.QsciScintilla):
    ...
    def __init__(self,  parent):
        ...
        palette.setColor(QPalette.Base, QColor(31, 59, 70))
