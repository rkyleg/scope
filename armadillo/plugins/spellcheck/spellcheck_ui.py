...
#
# Created: Tue Apr 28 02:22:10 2015
...
"}"))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("../../img/redo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("../../img/undo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
