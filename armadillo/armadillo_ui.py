...
#
# Created: Tue Feb  3 23:18:54 2015
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.fr_toolbar.setStyleSheet(_fromUtf8("QPushButton {\n"
...
"}"))
        ...
        self.b_workspace.setMaximumSize(QtCore.QSize(40, 31))
...
"}"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("img/workspace.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_workspace.setIcon(icon1)
...
"color:white;"))
        ...
        self.b_find.setMaximumSize(QtCore.QSize(32, 31))
...
"border-radius:3px;"))
        ...
        self.b_new.setMaximumSize(QtCore.QSize(40, 31))
...
"}"))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("img/new.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_new.setIcon(icon3)
        self.b_new.setObjectName(_fromUtf8("b_new"))
        self.gridLayout_2.addWidget(self.b_new, 0, 0, 1, 1)
        self.b_open = QtGui.QPushButton(self.fr_toolbar)
        self.b_open.setMinimumSize(QtCore.QSize(40, 25))
        self.b_open.setMaximumSize(QtCore.QSize(40, 31))
        self.b_open.setStyleSheet(_fromUtf8("QPushButton {\n"
"    border-left:1px solid rgb(130,130,130);\n"
"}"))
        self.b_open.setText(_fromUtf8(""))
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("img/file_open.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_open.setIcon(icon4)
        ...
        self.b_save.setMinimumSize(QtCore.QSize(40, 25))
        self.b_save.setMaximumSize(QtCore.QSize(40, 31))
        self.b_save.setStyleSheet(_fromUtf8("QPushButton {\n"
"    border-left:1px solid rgb(130,130,130);\n"
...
"}"))
        ...
        self.b_help = QtGui.QPushButton(self.fr_toolbar)
        self.b_help.setMinimumSize(QtCore.QSize(32, 25))
        self.b_help.setMaximumSize(QtCore.QSize(32, 31))
        self.b_help.setStyleSheet(_fromUtf8("QPushButton {\n"
"    border-top-left-radius:5px;\n"
"    border-bottom-left-radius:5px;\n"
"}"))
        self.b_help.setText(_fromUtf8(""))
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8("img/home.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_help.setIcon(icon6)
        self.b_help.setObjectName(_fromUtf8("b_help"))
        self.gridLayout_2.addWidget(self.b_help, 0, 5, 1, 1)
        self.b_settings = QtGui.QPushButton(self.fr_toolbar)
        self.b_settings.setMinimumSize(QtCore.QSize(32, 25))
        self.b_settings.setMaximumSize(QtCore.QSize(32, 31))
        self.b_settings.setStyleSheet(_fromUtf8("QPushButton {\n"
"    border-left:1px solid rgb(130,130,130);\n"
"    border-top-right-radius:5px;\n"
"    border-bottom-right-radius:5px;\n"
"}"))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8("img/wrench.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_settings.setIcon(icon7)
        ...
        self.b_indent.setMinimumSize(QtCore.QSize(32, 25))
        self.b_indent.setMaximumSize(QtCore.QSize(32, 31))
        self.b_indent.setStyleSheet(_fromUtf8("QPushButton {\n"
"    border-top-left-radius:5px;\n"
"    border-bottom-left-radius:5px;\n"
"}"))
        self.b_indent.setText(_fromUtf8(""))
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8("img/indent.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_indent.setIcon(icon8)
        ...
        self.b_unindent.setMinimumSize(QtCore.QSize(32, 25))
        self.b_unindent.setMaximumSize(QtCore.QSize(32, 31))
        self.b_unindent.setStyleSheet(_fromUtf8("QPushButton {\n"
"    border-left:1px solid rgb(130,130,130);\n"
"}"))
        self.b_unindent.setText(_fromUtf8(""))
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8("img/indent_remove.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.b_comment.setMinimumSize(QtCore.QSize(32, 25))
        self.b_comment.setMaximumSize(QtCore.QSize(32, 31))
        self.b_comment.setStyleSheet(_fromUtf8("QPushButton {\n"
"    border-left:1px solid rgb(130,130,130);\n"
"}"))
        self.b_comment.setText(_fromUtf8(""))
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8("img/comment.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.b_color_picker.setMinimumSize(QtCore.QSize(32, 25))
        self.b_color_picker.setMaximumSize(QtCore.QSize(32, 31))
        self.b_color_picker.setStyleSheet(_fromUtf8("QPushButton {\n"
"    border-left:1px solid rgb(130,130,130);\n"
"    border-top-right-radius:5px;\n"
"    border-bottom-right-radius:5px;\n"
"}"))
        ...
        self.b_run.setMinimumSize(QtCore.QSize(44, 25))
        self.b_run.setMaximumSize(QtCore.QSize(50, 31))
        self.b_run.setStyleSheet(_fromUtf8("QPushButton {\n"
"    border-top-left-radius:5px;\n"
"    border-bottom-left-radius:5px;\n"
"    border-top-right-radius:5px;\n"
"    border-bottom-right-radius:5px;\n"
