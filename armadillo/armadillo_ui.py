...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tab_left.setTabPosition(QtGui.QTabWidget.South)
        ...
        self.b_show_left_plugins.setIcon(icon1)
        ...
        spacerItem = QtGui.QSpacerItem(20, 289, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
...
"}"))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("img/home.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_help.setIcon(icon3)
...
"}"))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8("img/comment.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_comment.setIcon(icon5)
...
"}"))
        ...
        spacerItem6 = QtGui.QSpacerItem(6, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
...
"}"))
    ...
    def retranslateUi(self, Form):
        ...
        self.b_show_left_plugins.setToolTip(_translate("Form", "New", None))
        ...
        self.l_statusbar.setText(_translate("Form", "Status", None))
