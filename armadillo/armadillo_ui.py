...
#
# Created: Mon Mar  9 22:18:47 2015
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame = QtGui.QFrame(self.fr_topbar)
...
"}"))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("img/new.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("img/workspace.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_workspace.setIcon(icon3)
        self.b_workspace.setObjectName(_fromUtf8("b_workspace"))
        self.gridLayout.addWidget(self.b_workspace, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_open, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_help, 0, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_settings, 0, 5, 1, 1)
...
"}"))
    ...
    def retranslateUi(self, Form):
        ...
        self.b_new.setProperty("class", _translate("Form", "toolbar toolbar-left", None))
        self.b_workspace.setToolTip(_translate("Form", "Workspaces", None))
        self.b_workspace.setProperty("class", _translate("Form", "toolbar toolbar-middle", None))
        self.b_open.setToolTip(_translate("Form", "Open", None))
        self.b_open.setProperty("class", _translate("Form", "toolbar toolbar-middle", None))
        self.b_save.setToolTip(_translate("Form", "Save", None))
        self.b_save.setProperty("class", _translate("Form", "toolbar toolbar-right", None))
        self.b_help.setToolTip(_translate("Form", "Armadillo start page and help links", None))
        self.b_help.setProperty("class", _translate("Form", "toolbar toolbar-left", None))
        self.b_settings.setToolTip(_translate("Form", "Edit Settings", None))
        self.b_settings.setProperty("class", _translate("Form", "toolbar toolbar-right", None))
