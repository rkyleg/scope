...
#
# Created: Sat Aug 29 00:30:20 2015
...
"}"))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/launch.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_tools.setIcon(icon5)
