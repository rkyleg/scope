...
"}"))
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/tri_right.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/menu.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_menu.setIcon(icon13)
