...
#
# Created: Tue Aug 18 00:04:14 2015
...
"}"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/home.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_home.setIcon(icon1)
        self.b_home.setIconSize(QtCore.QSize(36, 36))
        self.b_home.setObjectName(_fromUtf8("b_home"))
        self.verticalLayout.addWidget(self.b_home)
        self.b_editor = QtGui.QPushButton(self.fr_leftbar)
        self.b_editor.setText(_fromUtf8(""))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/editor.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_editor.setIcon(icon2)
        self.b_editor.setIconSize(QtCore.QSize(36, 36))
        self.b_editor.setObjectName(_fromUtf8("b_editor"))
        self.verticalLayout.addWidget(self.b_editor)
        self.b_new = QtGui.QPushButton(self.fr_leftbar)
        self.b_new.setText(_fromUtf8(""))
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/new.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_new.setIcon(icon3)
        self.b_new.setIconSize(QtCore.QSize(36, 36))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/launch.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_tools.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/search.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_toggle_find.setIcon(icon5)
...
"}"))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/menu.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/tri_down.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_show_tabs.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/indent_remove.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_unindent.setIcon(icon8)
        self.b_unindent.setObjectName(_fromUtf8("b_unindent"))
        self.gridLayout.addWidget(self.b_unindent, 0, 4, 1, 1)
        self.b_color_picker = QtGui.QPushButton(self.fr_toolbar)
        self.b_color_picker.setText(_fromUtf8(""))
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/color_swatch.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_color_picker.setIcon(icon9)
        self.b_color_picker.setObjectName(_fromUtf8("b_color_picker"))
        self.gridLayout.addWidget(self.b_color_picker, 0, 6, 1, 1)
        self.b_indent = QtGui.QPushButton(self.fr_toolbar)
        self.b_indent.setText(_fromUtf8(""))
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/indent.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_indent.setIcon(icon10)
        self.b_indent.setObjectName(_fromUtf8("b_indent"))
        self.gridLayout.addWidget(self.b_indent, 0, 3, 1, 1)
        self.b_comment = QtGui.QPushButton(self.fr_toolbar)
        self.b_comment.setText(_fromUtf8(""))
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/comment.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_comment.setIcon(icon11)
        self.b_comment.setObjectName(_fromUtf8("b_comment"))
        self.gridLayout.addWidget(self.b_comment, 0, 5, 1, 1)
        self.b_save = QtGui.QPushButton(self.fr_toolbar)
        self.b_save.setText(_fromUtf8(""))
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/save.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_save.setIcon(icon12)
        self.b_save.setObjectName(_fromUtf8("b_save"))
        self.gridLayout.addWidget(self.b_save, 0, 2, 1, 1)
        spacerItem5 = QtGui.QSpacerItem(4, 2, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem5, 0, 1, 1, 1)
        self.b_run = QtGui.QPushButton(self.fr_toolbar)
        self.b_run.setText(_fromUtf8(""))
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/tri_right.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_run.setIcon(icon13)
        self.b_run.setObjectName(_fromUtf8("b_run"))
        self.gridLayout.addWidget(self.b_run, 0, 7, 1, 1)
        ...
        self.gridLayout_2.addItem(spacerItem6, 0, 8, 1, 1)
