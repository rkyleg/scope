...
#
# Created: Thu Sep 17 17:16:35 2015
...
"}"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/editor_windows.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/editor_new.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/editor_workspace.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.fr_tab.setMinimumSize(QtCore.QSize(250, 30))
        ...
        self.gridLayout_6.addWidget(self.l_title_prefix, 0, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.b_closetab, 0, 6, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.l_filename, 0, 5, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.b_tabicon, 0, 4, 1, 1)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/tri_right.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/comment.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayout.addWidget(self.b_unindent, 0, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_indent, 0, 6, 1, 1)
        self.b_save = QtGui.QPushButton(self.fr_toolbar)
        self.b_save.setText(_fromUtf8(""))
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/save.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_save.setIcon(icon11)
        self.b_save.setObjectName(_fromUtf8("b_save"))
        self.gridLayout.addWidget(self.b_save, 0, 5, 1, 1)
        self.b_menu = QtGui.QPushButton(self.fr_toolbar)
        self.b_menu.setMinimumSize(QtCore.QSize(42, 24))
        ...
        spacerItem3 = QtGui.QSpacerItem(2, 2, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem3, 0, 11, 1, 1)
        self.gridLayout_2.addWidget(self.fr_toolbar, 0, 3, 1, 1)
        spacerItem4 = QtGui.QSpacerItem(6, 10, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
...
"}"))
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8("../style/img/search.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_find.setIcon(icon13)
    ...
    def retranslateUi(self, Form):
        ...
        self.b_show_tabs.setToolTip(_translate("Form", "Window Switcher - View Open Files and Workspaces", None))
        self.b_new.setToolTip(_translate("Form", "New File", None))
        ...
        self.b_save.setProperty("class", _translate("Form", "toolbar toolbar-big toolbar-right", None))
        self.b_menu.setToolTip(_translate("Form", "Editor Menu", None))
