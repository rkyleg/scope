...
#
# Created: Sat Feb  8 22:50:14 2014
...
"}"))
        ...
        self.b_plugins.setStyleSheet(_fromUtf8("QToolButton {\n"
...
"}"))
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8("img/indent_remove.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
